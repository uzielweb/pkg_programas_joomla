 ...
 * @since  1.6
 */
class ProgramasControllerPrograma extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Programa', 'ProgramasModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_programas') || $user->authorise('core.edit.state', 'com_programas'))
		{
			$model = $this->getModel('Programa', 'ProgramasModel');
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_programas&view=programas', false));
			}
			else
			{
	...
	public function remove()
	{
		...
		if ($user->authorise('core.delete', 'com_programas'))
		{
			$model = $this->getModel('Programa', 'ProgramasModel');
